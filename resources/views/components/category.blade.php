<article class="`h-[170px] w-[130px] {{$category['backgroundcolor']}} rounded-md shadow-md overflow-hidden cursor-pointer border-2 hover:border-slate-100 border-transparent`">
